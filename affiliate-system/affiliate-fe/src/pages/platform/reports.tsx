              ...
              <table className='w-full text-xs'>
                <thead className='bg-gray-50 text-gray-700 font-semibold'>
                  <tr>
                    ...
                    <th className='px-3 py-2 text-right'>Casino NGR</th>
                    <th className='px-3 py-2 text-right'>Sportsbook NGR</th>
                    <th className='px-3 py-2 text-right'>Combined NGR</th>
                    <th className='px-3 py-2 text-right'>Players</th>
                  </tr>
                </thead>
                <tbody className='divide-y divide-gray-100 text-gray-700'>
                  {overview.data.byOperator.length === 0 && (
                    <tr><td colSpan={9} className='px-3 py-6 text-center text-gray-500'>No activity in the selected window.</td></tr>
                  )}
                  {overview.data.byOperator.map((row) => (
                    <tr key={row.operatorId || 'unknown'}>
                      ...
                      <td className='px-3 py-2 text-right'>{fmtMoney(row.computedNgrCents)}</td>
                      <td className='px-3 py-2 text-right'>{fmtMoney(row.sbNgrCents)}</td>
                      <td className='px-3 py-2 text-right font-semibold'>{fmtMoney(row.combinedNgrCents)}</td>
              ...
              <table className='w-full text-xs'>
                <thead className='bg-gray-50 text-gray-700 font-semibold'>
                  <tr>
                    ...
                    <th className='px-3 py-2 text-right'>Cashouts</th>
                    <th className='px-3 py-2 text-right'>Casino NGR</th>
                    <th className='px-3 py-2 text-right'>SB NGR</th>
                    <th className='px-3 py-2 text-right'>Combined NGR</th>
                  </tr>
                </thead>
                <tbody className='divide-y divide-gray-100 text-gray-700'>
                  {overview.data.byDay.length === 0 && (
                    <tr><td colSpan={8} className='px-3 py-6 text-center text-gray-500'>No daily rows.</td></tr>
                  )}
