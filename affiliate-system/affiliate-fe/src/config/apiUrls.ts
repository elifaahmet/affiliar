...
export const AFFILIATE_PORTAL_API_URLS = {
  ...
  DISPATCH_SUB_PAYOUT:   (payoutId: string) => `${API_BASE_URL}api/affiliate-portal/sub-payouts/${payoutId}/dispatch`,
  CANCEL_SUB_PAYOUT:     (payoutId: string) => `${API_BASE_URL}api/affiliate-portal/sub-payouts/${payoutId}/cancel`,
  ...
  POSTBACK:            () => `${API_BASE_URL}api/affiliate-portal/postback`,
  POSTBACK_DELIVERIES: () => `${API_BASE_URL}api/affiliate-portal/postback/deliveries`,
  PLAYER_REF:          (playerId: string) => `${API_BASE_URL}api/affiliate-portal/players/${playerId}/ref`,
...
export const AFFILIATE_PLAYERS_API_URLS = {
  ...
  SYNC_TEST:         () => `${API_BASE_URL}api/players/sync-test`,
};
