...
const ROUTES = {
  ...
  bonuses:          { operator: "/bonus-offers",              affiliate: "/affiliate/bonus-offers" },
...
const NAV_INTENTS = [
  ...
  { key: "bonuses",          label: "Bonuses",          reply: "Player bonuses you can distribute are here.", test: (t) => has(t, "bonus", "promo", "free spin", "deposit match", "cashback", "promosyon") },
